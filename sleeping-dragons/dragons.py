...
# hero = Actor("hero2", pos=HERO_START) # Uncomment this line to use the second hero image

def draw():
    global lairs, lives, eggs_collected, game_complete
    screen.clear()
